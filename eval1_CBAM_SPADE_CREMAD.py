...
def main():
    ...
    model = generator.Generator_CBAM_SPADE()
...
def eval(model, test_dataloader):
    ...
    for step, (x, indiv_mels, mel, gt) in prog_bar:
        ...
        #SSIM: 0.869; PSNR: 22.000; FID: 57.408; LPIPS: 0.080; CPBD: 0.231; CSIM: 0.001; LMD: 0.008; POSE: 0.004; CONTENT: 0.012
...
if __name__ == '__main__':
    ...
    hparams.result_path = "./result1_CBAM_SPADE"
    hparams.pretrained = "/media/cxnam/cxnam_folder/HaftFusion/result1_CBAM_SPADE/gen_e30-2024-02-18 02:56:32.732358.pt"
