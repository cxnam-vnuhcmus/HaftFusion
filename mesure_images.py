...
def main():
    eval('/home/cxnam/Documents/img_folder/0_1_pd_enhance.jpg', 
         '/home/cxnam/Documents/img_folder/0_1_gt.jpg')
    
def eval(pred_file, gt_file):
    #Validation
    ...
    print(ssim_score)   #0.9276799312871148
    
    psnr_score = calculate_psnr(g, gt)
    running_psnr_score += psnr_score
    
    print(psnr_score) #31.23709861701926
    ...
    print(lpips_score)  #0.03977098331704301
    
    cpbd_score = calculate_cpbd(g)
    running_cpbd_score += cpbd_score
    
    print(cpbd_score)   #0.8
    ...
    # print('SSIM: {:.3f}; PSNR: {:.3f}; FID: {:.3f}; LPIPS: {:.3f}; CPBD: {:.3f}; CSIM: {:.3f}; LMD: {:.3f}; POSE: {:.3f}; CONTENT: {:.3f} '.format(
...
if __name__ == '__main__':
    hparams.test_file="./data/test.txt"
    hparams.audio_root="/media/cxnam/datasets/CREMA-D/IPLAP_audio/VideoFPS25"
    hparams.face_root= "/media/cxnam/datasets/CREMA-D/IPLAP_face/VideoFPS25"
    hparams.result_path = "./result"
    hparams.pretrained = "/media/cxnam/cxnam_folder/HaftFusion/pretrained/HaftFusion_Result1_CBAM/gen_e195-2023-12-09 23:30:48.693524.pt"
