...
class Custom_Dataset(Dataset):
    ...
    def get_window(self, start_frame):
        ...
        for frame_id in range(start_id, start_id + syncnet_T):
            frame = os.path.join(vidname, '{}.png'.format(frame_id))
    ...
    def __getitem__(self, idx):
        while 1:
            ...
            img_names = list(glob(os.path.join(hparams.face_root, vidname, '*.png')))
            ...
            try:
                wavpath = os.path.join(hparams.audio_root, vidname, "audio.wav")
