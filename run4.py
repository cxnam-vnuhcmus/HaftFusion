...
def train(model, optimizer, disc, disc_optimizer, train_dataloader):
    ...
    for epoch in range(current_epoch, hparams.nepochs):
        ...
        for step, (x, indiv_mels, mel, gt) in prog_bar:
            ...
            pred_real = disc(face_sequences_gt.detach())
...
if __name__ == '__main__':
    hparams.pretrained = '/root/cxnam/HaftFusion/result4/gen_e5-2023-12-02 20:18:29.949334.pt'
    hparams.disc_pretrained = '/root/cxnam/HaftFusion/result4/disc_e5-2023-12-02 20:18:29.949334.pt'
    hparams.result_path = './result4_1'
    main()
