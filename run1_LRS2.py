...
def main():
    train_dataloader = data_loader_LRS2.Create_Dataloader(hparams.train_file, batch_size=hparams.batch_size, num_workers=hparams.num_workers)
...
if __name__ == '__main__':
    hparams.result_path = './result1_LRS2'
    main()