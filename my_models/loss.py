...
def _vgg19(layers):
    r"""Get vgg19 layers"""
    network = torchvision.models.vgg19(weights=VGG19_Weights.DEFAULT).features
    ...
    def get_target_tensor(self, input, target_is_real):
        ...
        if target_is_real:
            ...
            if create_label:
                ...
                real_tensor = torch.full(input.size(), self.real_label, device=input.device)
            ...
            if create_label:
                ...
                fake_tensor = torch.full(input.size(), self.fake_label, device=input.device)
