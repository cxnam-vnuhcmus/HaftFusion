    ...
    def __init__(self, pretrained: bool = False,in_ch: int = 3):
        super().__init__(
            inverted_residual_setting=[
                ...
                InvertedResidualConfig( 16, 3,  64,  32, False, "RE", 2, 1, 1),  # C1
                InvertedResidualConfig( 32, 3,  72,  32, False, "RE", 1, 1, 1),
                InvertedResidualConfig( 32, 5,  72,  64,  True, "RE", 2, 1, 1),  # C2
                InvertedResidualConfig( 64, 5, 120,  64,  True, "RE", 1, 1, 1),
                InvertedResidualConfig( 64, 5, 120,  64,  True, "RE", 1, 1, 1),
                InvertedResidualConfig( 64, 3, 240,  80, False, "HS", 2, 1, 1),  # C3
                ...
                InvertedResidualConfig(112, 5, 672, 128,  True, "HS", 2, 2, 1),  # C4
                InvertedResidualConfig(128, 5, 960, 128,  True, "HS", 1, 2, 1),
                InvertedResidualConfig(128, 5, 960, 128,  True, "HS", 1, 2, 1),
            ],
            last_channel=1280
        )
...
class MobileNetV3LargeEncoder_CBAM(MobileNetV3):
    def __init__(self, pretrained: bool = False,in_ch: int = 3):
        super().__init__(
            inverted_residual_setting=[
                InvertedResidualConfig( 16, 3,  16,  16, False, "RE", 1, 1, 1),
        ...
        self.ca = nn.Sequential(*[ChannelAttention(16),
                   ChannelAttention(32),
                   ChannelAttention(64),
                   ChannelAttention(128),
                   ])
        self.sa = nn.Sequential(*[SpatialAttention(),
                   SpatialAttention(),
                   SpatialAttention(),
                   SpatialAttention(),
                   ])
